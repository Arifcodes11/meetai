...
export const UpgradeView = () => {
  ...
  return (
    <div className="flex-1 py-4 px-8 flex flex-col gap-y-10">
      <div className="mt-4 flex-1 flex-col gap-y-10 items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {products.map((product) => {
            ...
            const isPremium = "Upgrade";

            let buttonText = isCurrentProduct
              ? "Manage"
              : "> authClient.checkout({ products: [product] });";
